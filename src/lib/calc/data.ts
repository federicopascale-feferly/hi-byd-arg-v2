...
const raw = [
  ...
  { id: 'yuan-pro', nombre: 'Yuan Pro', tipo: 'EV', batteryKw: 45.12, maxAc: 6.6, maxDc: 65, electricRange: 380 , descripcion: 'SUV 100% eléctrico de entrada a la marca: 380 km de autonomía y carga rápida DC de hasta 65 kW.' },
