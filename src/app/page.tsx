  ...
  return (
    <main className="mx-auto w-full max-w-5xl flex-1 px-4 py-8 sm:px-6 sm:py-12">
      <header className="mb-8">
        <p className="text-xs font-medium uppercase tracking-[0.18em] text-accent">Hi BYD Argentina</p>
        <h1 className="mt-2 bg-gradient-to-r from-primary-hover to-accent-fill bg-clip-text text-3xl font-bold leading-tight text-transparent sm:text-4xl">
